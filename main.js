$(function() {
    ...
    // 問題
    const MONDAI_LIST = [
      {yomi:'プリン', text:'purinn'},
      {yomi:'パンケーキ', text:'pannke-ki'},
      {yomi:'コーヒーゼリー', text:'ko-hi-zeri-'},
      {yomi:'チョコバナナパフェ', text:'tyokobananapafe'},
      {yomi:'杏仁豆腐', text:'annninndouhu'},
      {yomi:'フルーツタルト', text:'hutu-tutaruto'},
      {yomi:'スイートポテト', text:'sui-topoteto'},
      {yomi:'ショートケーキ', text:'syo-toke-ki'},
      {yomi:'チーズケーキ', text:'ti-zuke-ki'},
      {yomi:'ヨーグルト', text:'yo-guruto'},
      {yomi:'マカロン', text:'makaronn'},
      {yomi:'わらびもち', text:'warabimoti'},
      {yomi:'オレンジゼリー', text:'orenjizeri-'},
      {yomi:'どらやき', text:'dorayaki'},
      {yomi:'シュークリーム', text:'syu-kuri-mu'}, 
      {yomi:'エクレア', text:'ekurea'},
      {yomi:'フレンチトースト', text:'hurenntito-suto'},
    ];
